...
class CombinedROIHeads(torch.nn.ModuleDict):
    ...
    def forward(self, features, proposals, targets=None, logger=None):
        ...
        if self.cfg.MODEL.RELATION_ON:
            ...
            if self.training and self.cfg.MODEL.ct_loss:
                loss_relation, q_feats, rel_labels, cut_labels, relation_logits = loss_relation
                losses.update(loss_relation)
                return x, detections, [losses, q_feats, rel_labels, cut_labels, relation_logits]
