...
def make_batch_data_sampler(
    ...
    if not cfg.MODEL.Feature_Generation_Mode and num_iters is not None:
...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0, dataset_to_test=None):
    ...
    if is_train:
        ...
        if cfg.MODEL.Feature_Generation_Mode and "MotifPredictor" in cfg.MODEL.ROI_RELATION_HEAD.PREDICTOR:
            images_per_gpu = 1
        shuffle = True if not cfg.MODEL.Feature_Generation_Mode else False
